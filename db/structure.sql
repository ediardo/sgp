...
CREATE TABLE "pedidos" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "num_pedido" varchar(255), "descripcion" text, "finalizado" boolean, "cliente_id" integer, "created_at" datetime, "updated_at" datetime, "estados_count" integer, "created_by" varchar(255), "updated_by" varchar(255));
...
CREATE TABLE "estados" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "nota" varchar(255), "tipo_estado_id" integer, "pedido_id" integer, "created_at" datetime, "updated_at" datetime, "created_by" varchar(255), "updated_by" varchar(255));
...
INSERT INTO schema_migrations (version) VALUES ('20140609065012');

INSERT INTO schema_migrations (version) VALUES ('20140609065604');

INSERT INTO schema_migrations (version) VALUES ('20140609070104');

INSERT INTO schema_migrations (version) VALUES ('20140609070419');

INSERT INTO schema_migrations (version) VALUES ('20140609072449');
